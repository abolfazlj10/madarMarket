const SpecialProductsItem = () => {
    return(
        <div className="border border-[#F5F2EF] rounded-b-3xl rounded-t-xl overflow-hidden w-[200px]">
            <img src="icons/specialImag.png" className="mx-auto" />
            <div className="">روغن زیتون بکر کریستال - 5 لیتر</div>
            <div>
            ...
            <div className="bg-[#F7F7F7] border border-[#F5F2EF] rounded-3xl text-center py-2">افزودن به سبد</div>
        </div>
    )
}
